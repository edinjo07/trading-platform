...
const DARK_OVERRIDES: Record<string, string | number | boolean> = {
  ...
  'mainSeriesProperties.candleStyle.upColor':          '#18c98a',
  'mainSeriesProperties.candleStyle.downColor':        '#ff5a72',
  'mainSeriesProperties.candleStyle.borderUpColor':    '#18c98a',
  'mainSeriesProperties.candleStyle.borderDownColor':  '#ff5a72',
  ...
  useEffect(() => {
    ...
    function createWidget() {
      ...
      widgetRef.current = new window.TradingView.widget({
        ...
        timezone:          'Etc/UTC',
        toolbar_bg:        '#06090f',
        loading_screen:    { backgroundColor: '#06090f', foregroundColor: '#4f8cff' },
