...
export const SYMBOLS: Symbol[] = [
  ...
  { symbol: 'USD/ILS', name: 'US Dollar / Israeli Shekel',    assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'ILS' },
  { symbol: 'USD/SAR', name: 'US Dollar / Saudi Riyal',       assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'SAR' },
  { symbol: 'USD/AED', name: 'US Dollar / UAE Dirham',        assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'AED' },
  { symbol: 'USD/TRY', name: 'US Dollar / Turkish Lira',      assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'TRY' },
  // Asian
  { symbol: 'USD/CNY', name: 'US Dollar / Chinese Yuan',      assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'CNY' },
  { symbol: 'USD/INR', name: 'US Dollar / Indian Rupee',      assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'INR' },
  { symbol: 'USD/HKD', name: 'US Dollar / Hong Kong Dollar',  assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'HKD' },
  { symbol: 'USD/SGD', name: 'US Dollar / Singapore Dollar',  assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'SGD' },
  { symbol: 'AUD/JPY', name: 'Australian Dollar / Jap. Yen',  assetClass: 'forex', baseAsset: 'AUD', quoteAsset: 'JPY' },
  { symbol: 'CAD/JPY', name: 'Canadian Dollar / Jap. Yen',    assetClass: 'forex', baseAsset: 'CAD', quoteAsset: 'JPY' },
  // Americas & EM
  { symbol: 'USD/MXN', name: 'US Dollar / Mexican Peso',      assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'MXN' },
  { symbol: 'USD/BRL', name: 'US Dollar / Brazilian Real',    assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'BRL' },
  { symbol: 'USD/ZAR', name: 'US Dollar / South African Rand',assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'ZAR' },
  { symbol: 'USD/NOK', name: 'US Dollar / Norwegian Krone',   assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'NOK' },
  { symbol: 'USD/SEK', name: 'US Dollar / Swedish Krona',     assetClass: 'forex', baseAsset: 'USD', quoteAsset: 'SEK' },
  // Euro crosses
  { symbol: 'EUR/CHF', name: 'Euro / Swiss Franc',            assetClass: 'forex', baseAsset: 'EUR', quoteAsset: 'CHF' },
  { symbol: 'EUR/AUD', name: 'Euro / Australian Dollar',      assetClass: 'forex', baseAsset: 'EUR', quoteAsset: 'AUD' },
  { symbol: 'EUR/CAD', name: 'Euro / Canadian Dollar',        assetClass: 'forex', baseAsset: 'EUR', quoteAsset: 'CAD' },
  // More Crypto
  ...
  { symbol: 'BRENT/USD',   name: 'Brent Crude Oil', assetClass: 'commodity', baseAsset: 'BRENT',  quoteAsset: 'USD' },
  { symbol: 'HO/USD',      name: 'Heating Oil',     assetClass: 'commodity', baseAsset: 'HO',     quoteAsset: 'USD' },
  { symbol: 'XPT/USD',     name: 'Platinum',        assetClass: 'commodity', baseAsset: 'XPT',    quoteAsset: 'USD' },
  { symbol: 'XPD/USD',     name: 'Palladium',       assetClass: 'commodity', baseAsset: 'XPD',    quoteAsset: 'USD' },
  { symbol: 'COPPER/USD',  name: 'Copper',          assetClass: 'commodity', baseAsset: 'COPPER', quoteAsset: 'USD' },
  { symbol: 'COFFEE/USD',  name: 'Coffee',          assetClass: 'commodity', baseAsset: 'COFFEE', quoteAsset: 'USD' },
  { symbol: 'SUGAR/USD',   name: 'Sugar #11',       assetClass: 'commodity', baseAsset: 'SUGAR',  quoteAsset: 'USD' },
  { symbol: 'COCOA/USD',   name: 'Cocoa',           assetClass: 'commodity', baseAsset: 'COCOA',  quoteAsset: 'USD' },
  { symbol: 'COTTON/USD',  name: 'Cotton #2',       assetClass: 'commodity', baseAsset: 'COTTON', quoteAsset: 'USD' },
  { symbol: 'SOYBEAN/USD', name: 'Soybeans',        assetClass: 'commodity', baseAsset: 'SOYBEAN',quoteAsset: 'USD' },
  { symbol: 'LUMBER/USD',  name: 'Lumber',          assetClass: 'commodity', baseAsset: 'LUMBER', quoteAsset: 'USD' },
  // Indices
...
const PARAMS: Record<string, InstrumentParams> = {
  ...
  // Middle East & Geopolitical
  'USD/ILS': { basePrice: 3.740,   annualVol: 0.12, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.001,   baseVolume: 2e10  },
  'USD/SAR': { basePrice: 3.751,   annualVol: 0.01, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001,  avgSpread: 0.0002,  baseVolume: 1e10  },
  'USD/AED': { basePrice: 3.673,   annualVol: 0.01, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001,  avgSpread: 0.0002,  baseVolume: 8e9   },
  'USD/TRY': { basePrice: 36.20,   annualVol: 0.28, annualDrift: 0.05, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.003,   baseVolume: 3e10  },
  // Asian
  'USD/CNY': { basePrice: 7.240,   annualVol: 0.04, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001,  avgSpread: 0.0002,  baseVolume: 3e11  },
  'USD/INR': { basePrice: 83.60,   annualVol: 0.05, annualDrift: 0.00, priceDecimals: 2, tickSize: 0.01,    avgSpread: 0.002,   baseVolume: 1.5e11 },
  'USD/HKD': { basePrice: 7.826,   annualVol: 0.01, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001,  avgSpread: 0.0001,  baseVolume: 2e11  },
  'USD/SGD': { basePrice: 1.344,   annualVol: 0.05, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001,  avgSpread: 0.0001,  baseVolume: 1e11  },
  'AUD/JPY': { basePrice: 97.20,   annualVol: 0.11, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.009,   baseVolume: 1e11  },
  'CAD/JPY': { basePrice: 109.50,  annualVol: 0.09, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.009,   baseVolume: 8e10  },
  // Americas & EM
  'USD/MXN': { basePrice: 17.40,   annualVol: 0.14, annualDrift: 0.01, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.002,   baseVolume: 1.5e11 },
  'USD/BRL': { basePrice: 5.320,   annualVol: 0.18, annualDrift: 0.02, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.003,   baseVolume: 8e10  },
  'USD/ZAR': { basePrice: 18.60,   annualVol: 0.18, annualDrift: 0.02, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.003,   baseVolume: 6e10  },
  'USD/NOK': { basePrice: 10.72,   annualVol: 0.12, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.002,   baseVolume: 8e10  },
  'USD/SEK': { basePrice: 10.45,   annualVol: 0.11, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.002,   baseVolume: 7e10  },
  // Euro crosses
  'EUR/CHF': { basePrice: 0.9650,  annualVol: 0.05, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00006, baseVolume: 1.5e11 },
  'EUR/AUD': { basePrice: 1.6840,  annualVol: 0.10, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.0001,  baseVolume: 8e10  },
  'EUR/CAD': { basePrice: 1.5040,  annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.0001,  baseVolume: 8e10  },
  // More Crypto
  ...
  'BRENT/USD':   { basePrice: 82.50,    annualVol: 0.35, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0003, baseVolume: 1.8e8 },
  'HO/USD':      { basePrice: 2.65,     annualVol: 0.40, annualDrift: 0.01, priceDecimals: 4, tickSize: 0.0001,avgSpread: 0.0004, baseVolume: 5e7  },
  'XPT/USD':     { basePrice: 1000.00,  annualVol: 0.22, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0005, baseVolume: 1e7  },
  'XPD/USD':     { basePrice: 1060.00,  annualVol: 0.30, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0006, baseVolume: 8e6  },
  'COPPER/USD':  { basePrice: 4.25,     annualVol: 0.25, annualDrift: 0.03, priceDecimals: 4, tickSize: 0.0001,avgSpread: 0.0003, baseVolume: 3e8  },
  'COFFEE/USD':  { basePrice: 245.00,   annualVol: 0.40, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0005, baseVolume: 2e7  },
  'SUGAR/USD':   { basePrice: 21.50,    annualVol: 0.32, annualDrift: 0.01, priceDecimals: 3, tickSize: 0.001, avgSpread: 0.0004, baseVolume: 5e7  },
  'COCOA/USD':   { basePrice: 9800.00,  annualVol: 0.55, annualDrift: 0.05, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0006, baseVolume: 1.5e7 },
  'COTTON/USD':  { basePrice: 75.50,    annualVol: 0.28, annualDrift: 0.01, priceDecimals: 3, tickSize: 0.001, avgSpread: 0.0004, baseVolume: 2e7  },
  'SOYBEAN/USD': { basePrice: 1055.00,  annualVol: 0.25, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0003, baseVolume: 3e7  },
  'LUMBER/USD':  { basePrice: 540.00,   annualVol: 0.45, annualDrift: 0.00, priceDecimals: 2, tickSize: 0.01,  avgSpread: 0.0008, baseVolume: 5e6  },
  // Indices
