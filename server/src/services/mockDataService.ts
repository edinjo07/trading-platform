...
const PARAMS: Record<string, InstrumentParams> = {
  // ── Stocks ──────────────────────────────────────────────────────────────────
  AAPL:  { basePrice: 312.51, annualVol: 0.28, annualDrift: 0.12, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 8e7   },
  TSLA:  { basePrice: 442.10, annualVol: 0.60, annualDrift: 0.15, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 1.2e8 },
  NVDA:  { basePrice: 214.25, annualVol: 0.55, annualDrift: 0.20, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 4.5e7 },
  MSFT:  { basePrice: 426.99, annualVol: 0.25, annualDrift: 0.10, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 2.5e7 },
  GOOGL: { basePrice: 390.13, annualVol: 0.28, annualDrift: 0.11, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 2e7   },
  AMZN:  { basePrice: 274.00, annualVol: 0.30, annualDrift: 0.12, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 3e7   },
  META:  { basePrice: 635.29, annualVol: 0.42, annualDrift: 0.18, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 1.5e7 },
  JPM:   { basePrice: 296.73, annualVol: 0.24, annualDrift: 0.09, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 8e6   },
  NFLX:  { basePrice: 900.00, annualVol: 0.38, annualDrift: 0.13, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 5e6   },
  COIN:  { basePrice: 350.00, annualVol: 0.90, annualDrift: 0.20, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 1.5e7 },
  AMD:   { basePrice: 518.09, annualVol: 0.52, annualDrift: 0.16, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 4e7   },
  DIS:   { basePrice: 105.00, annualVol: 0.28, annualDrift: 0.06, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 1e7   },
  LMT:   { basePrice: 570.00, annualVol: 0.22, annualDrift: 0.11, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 1.2e6 },
  RTX:   { basePrice: 155.00, annualVol: 0.25, annualDrift: 0.10, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 5e6   },
  NOC:   { basePrice: 540.00, annualVol: 0.22, annualDrift: 0.09, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 8e5   },
  GD:    { basePrice: 320.00, annualVol: 0.20, annualDrift: 0.09, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 1.5e6 },
  BA:    { basePrice: 210.00, annualVol: 0.45, annualDrift: 0.08, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 8e6   },
  HII:   { basePrice: 285.00, annualVol: 0.28, annualDrift: 0.08, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 5e5   },
  LDOS:  { basePrice: 180.00, annualVol: 0.26, annualDrift: 0.10, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 8e5   },
  CACI:  { basePrice: 490.00, annualVol: 0.28, annualDrift: 0.11, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 3e5   },
  XOM:   { basePrice: 146.96, annualVol: 0.26, annualDrift: 0.08, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 2e7   },
  CVX:   { basePrice: 165.00, annualVol: 0.25, annualDrift: 0.07, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 1.5e7 },
  COP:   { basePrice: 125.00, annualVol: 0.28, annualDrift: 0.09, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0001, baseVolume: 8e6   },
  // ── Crypto ────────────────────────────────────────────────────────────────
  ...
  // ── Forex Majors ──────────────────────────────────────────────────────────
  EURUSD: { basePrice: 1.1639, annualVol: 0.07, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00005, baseVolume: 5e11   },
  GBPUSD: { basePrice: 1.3434, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00007, baseVolume: 3e11   },
  USDJPY: { basePrice: 159.37, annualVol: 0.06, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.005,   baseVolume: 4e11   },
  USDCHF: { basePrice: 0.7843, annualVol: 0.06, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00007, baseVolume: 2e11   },
  USDCAD: { basePrice: 1.3789, annualVol: 0.06, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00008, baseVolume: 2e11   },
  AUDUSD: { basePrice: 0.7157, annualVol: 0.09, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00007, baseVolume: 2.5e11 },
  NZDUSD: { basePrice: 0.5953, annualVol: 0.10, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00009, baseVolume: 1e11   },
  // ── Forex Minors ──────────────────────────────────────────────────────────
  AUDCAD: { basePrice: 0.9868, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.0001,  baseVolume: 8e10   },
  AUDCHF: { basePrice: 0.5614, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00012, baseVolume: 5e10   },
  AUDJPY: { basePrice: 114.06, annualVol: 0.11, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.009,   baseVolume: 1e11   },
  AUDNZD: { basePrice: 1.2021, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00015, baseVolume: 4e10   },
  CADCHF: { basePrice: 0.5688, annualVol: 0.07, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00012, baseVolume: 3e10   },
  CADJPY: { basePrice: 115.58, annualVol: 0.09, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.009,   baseVolume: 8e10   },
  CHFJPY: { basePrice: 203.18, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.01,    baseVolume: 4e10   },
  EURAUD: { basePrice: 1.6261, annualVol: 0.10, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.0001,  baseVolume: 8e10   },
  EURCAD: { basePrice: 1.6047, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.0001,  baseVolume: 8e10   },
  EURCHF: { basePrice: 0.9129, annualVol: 0.05, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00006, baseVolume: 1.5e11 },
  EURGBP: { basePrice: 0.8663, annualVol: 0.05, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00006, baseVolume: 1.5e11 },
  EURJPY: { basePrice: 185.49, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.007,   baseVolume: 2e11   },
  EURNZD: { basePrice: 1.9548, annualVol: 0.10, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00015, baseVolume: 4e10   },
  GBPAUD: { basePrice: 1.8769, annualVol: 0.11, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00015, baseVolume: 5e10   },
  GBPCAD: { basePrice: 1.8520, annualVol: 0.09, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00012, baseVolume: 4e10   },
  GBPCHF: { basePrice: 1.0537, annualVol: 0.08, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00012, baseVolume: 4e10   },
  GBPJPY: { basePrice: 214.11, annualVol: 0.10, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.009,   baseVolume: 1.5e11 },
  GBPNZD: { basePrice: 2.2564, annualVol: 0.11, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.0002,  baseVolume: 3e10   },
  NZDCAD: { basePrice: 0.8209, annualVol: 0.09, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00015, baseVolume: 3e10   },
  NZDCHF: { basePrice: 0.4670, annualVol: 0.09, annualDrift: 0.00, priceDecimals: 5, tickSize: 0.00001, avgSpread: 0.00015, baseVolume: 2e10   },
  NZDJPY: { basePrice: 94.88,  annualVol: 0.10, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,   avgSpread: 0.009,   baseVolume: 3e10   },
  // ── Forex Exotics ─────────────────────────────────────────────────────────
  ...
  USDCNH:  { basePrice: 6.770,  annualVol: 0.04, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001, avgSpread: 0.0001,  baseVolume: 3e11   },
  ...
  USDMXN:  { basePrice: 17.325, annualVol: 0.14, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,  avgSpread: 0.002,   baseVolume: 1.5e11 },
  USDNOK:  { basePrice: 10.20,  annualVol: 0.12, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001, avgSpread: 0.0002,  baseVolume: 8e10   },
  USDPLN:  { basePrice: 3.750,  annualVol: 0.10, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001, avgSpread: 0.0002,  baseVolume: 4e10   },
  USDSEK:  { basePrice: 9.850,  annualVol: 0.11, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001, avgSpread: 0.0002,  baseVolume: 4e10   },
  USDSGD:  { basePrice: 1.2771, annualVol: 0.05, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001, avgSpread: 0.0001,  baseVolume: 1e11   },
  USDTHB:  { basePrice: 32.50,  annualVol: 0.06, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,  avgSpread: 0.002,   baseVolume: 3e10   },
  USDZAR:  { basePrice: 16.238, annualVol: 0.18, annualDrift: 0.00, priceDecimals: 4, tickSize: 0.0001, avgSpread: 0.0003,  baseVolume: 6e10   },
  USDTRY:  { basePrice: 45.88,  annualVol: 0.28, annualDrift: 0.02, priceDecimals: 3, tickSize: 0.001,  avgSpread: 0.003,   baseVolume: 3e10   },
  ...
  // ── Commodities ───────────────────────────────────────────────────────────
  XAUUSD: { basePrice: 4503,   annualVol: 0.15, annualDrift: 0.05, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0002, baseVolume: 2e8   },
  XAGUSD: { basePrice: 75.58,  annualVol: 0.25, annualDrift: 0.03, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0004, baseVolume: 5e7   },
  XPTUSD: { basePrice: 1919,   annualVol: 0.22, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0005, baseVolume: 2e7   },
  XPDUSD: { basePrice: 1391,   annualVol: 0.30, annualDrift: 0.00, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.001,  baseVolume: 5e6   },
  XBRUSD: { basePrice: 92.23,  annualVol: 0.35, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0003, baseVolume: 1.5e8 },
  WTI:    { basePrice: 88.15,  annualVol: 0.35, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0003, baseVolume: 1.5e8 },
  BRENT:  { basePrice: 92.23,  annualVol: 0.34, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0003, baseVolume: 1.5e8 },
  NGAS:   { basePrice: 3.298,  annualVol: 0.55, annualDrift: 0.00, priceDecimals: 3, tickSize: 0.001,  avgSpread: 0.0005, baseVolume: 8e7   },
  GC25:   { basePrice: 4533,   annualVol: 0.15, annualDrift: 0.05, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0002, baseVolume: 1e8   },
  COCOA:  { basePrice: 4071,   annualVol: 0.40, annualDrift: 0.03, priceDecimals: 0, tickSize: 1,      avgSpread: 0.0005, baseVolume: 2e7   },
  COFFEE: { basePrice: 273.90, annualVol: 0.30, annualDrift: 0.02, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0005, baseVolume: 3e7   },
  CORN:   { basePrice: 455.38, annualVol: 0.25, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.25,   avgSpread: 0.0005, baseVolume: 5e7   },
  COTTON: { basePrice: 76.91,  annualVol: 0.28, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0005, baseVolume: 2e7   },
  OJ:     { basePrice: 167.60, annualVol: 0.35, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.001,  baseVolume: 5e6   },
  SOYBEAN:{ basePrice: 1198.88,annualVol: 0.25, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.25,   avgSpread: 0.0005, baseVolume: 3e7   },
  SUGAR:  { basePrice: 13.92,  annualVol: 0.30, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.01,   avgSpread: 0.0005, baseVolume: 4e7   },
  WHEAT:  { basePrice: 621.40, annualVol: 0.28, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.25,   avgSpread: 0.0005, baseVolume: 4e7   },
  COPPER: { basePrice: 6.416,  annualVol: 0.25, annualDrift: 0.02, priceDecimals: 3, tickSize: 0.001,  avgSpread: 0.0005, baseVolume: 5e7   },
  LUMBER: { basePrice: 588.00, annualVol: 0.45, annualDrift: 0.01, priceDecimals: 2, tickSize: 0.10,   avgSpread: 0.001,  baseVolume: 1e7   },
  HO:     { basePrice: 3.550,  annualVol: 0.38, annualDrift: 0.01, priceDecimals: 3, tickSize: 0.001,  avgSpread: 0.001,  baseVolume: 3e7   },
  // ── Indices ───────────────────────────────────────────────────────────────
  US500:   { basePrice: 5900,  annualVol: 0.18, annualDrift: 0.08, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 3e9  },
  USTEC:   { basePrice: 21000, annualVol: 0.22, annualDrift: 0.10, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 2e9  },
  US30:    { basePrice: 42500, annualVol: 0.16, annualDrift: 0.07, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 1e9  },
  UK100:   { basePrice: 8600,  annualVol: 0.16, annualDrift: 0.06, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 1.5e9 },
  DE40:    { basePrice: 23500, annualVol: 0.20, annualDrift: 0.08, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 1e9  },
  F40:     { basePrice: 8000,  annualVol: 0.18, annualDrift: 0.07, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 8e8  },
  JP225:   { basePrice: 37500, annualVol: 0.20, annualDrift: 0.07, priceDecimals: 0, tickSize: 1,    avgSpread: 0.0002, baseVolume: 2e9  },
  AUS200:  { basePrice: 8300,  annualVol: 0.16, annualDrift: 0.06, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 8e8  },
  STOXX50: { basePrice: 5400,  annualVol: 0.18, annualDrift: 0.07, priceDecimals: 2, tickSize: 0.01, avgSpread: 0.0002, baseVolume: 8e8  },
